...
<head>
    ...
    <title>code.tn - Online Courses & Education</title>

    <!--
      - custom css link
    -->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>./assets/css/style.css">
    <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>./assets/css/media_queries.css">
...
<div class="container">
    ...
    <main>
        ...
        <section class="home" id="home">
            ...
            <div class="home-left">
                ...
                <h1 class="main-heading">
                    Get Class From Top
                    <span class="underline-img">Instructor <img src="<?php echo get_template_directory_uri();?>./assets/images/banner-line.png" alt="line"></span>
                </h1>
            ...
            <div class="home-right">
                ...
                <div class="img-box">
                    ...
                    <img src="<?php echo get_template_directory_uri();?>./assets/images/banner-aliment-icon-2.png" alt="" class="icon-2 smooth-zigzag-anim-2" width="240">
                    <img src="<?php echo get_template_directory_uri();?>./assets/images/banner-aliment-icon-3.png" alt="" class="icon-3 smooth-zigzag-anim-3" width="195">
        ...
        <section class="category">
            ...
            <ul class="course-item-group">
                ...
                <li class="course-category-item">
                    ...
                    <div class="wrapper">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-1.png" alt="category icon" class="category-icon default">

                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-1-w.png" alt="category icon white"
                ...
                <li class="course-category-item">
                    ...
                    <div class="wrapper">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-2.png" alt="category icon" class="category-icon default">

                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-2-w.png" alt="category icon white"
                             class="category-icon hover">
                    </div>
                ...
                <li class="course-category-item">
                    ...
                    <div class="wrapper">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-3.png" alt="category icon" class="category-icon default">

                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-3-w.png" alt="category icon white"
                             class="category-icon hover">
                    </div>
                ...
                <li class="course-category-item">
                    ...
                    <div class="wrapper">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-4.png" alt="category icon" class="category-icon default">

                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-4-w.png" alt="category icon white"
                             class="category-icon hover">
                    </div>
                ...
                <li class="course-category-item">
                    ...
                    <div class="wrapper">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-5.png" alt="category icon" class="category-icon default">

                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-5-w.png" alt="category icon white"
                             class="category-icon hover">
                    </div>
                ...
                <li class="course-category-item">
                    ...
                    <div class="wrapper">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-6.png" alt="category icon" class="category-icon default">

                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-category-icon-6-w.png" alt="category icon white"
                             class="category-icon hover">
                    </div>
            ...
            <div class="course-grid">
                ...
                <div class="course-card">
                    ...
                    <div class="course-banner">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-1.jpg" alt="course banner">
                    ...
                    <div class="course-content">
                        ...
                        <div class="wrapper border-bottom">
                            ...
                            <div class="author">
                                <img src="<?php echo get_template_directory_uri();?>./assets/images/course-instructor-img.jpg" alt="course instructor image" class="author-img">
                        ...
                        <div class="wrapper">
                            ...
                            <div class="enrolled">
                                <div class="icon-user">
                                    <img src="<?php echo get_template_directory_uri();?>./assets/images/student-icon.png" alt="user icon">
                                </div>
                ...
                <div class="course-card">
                    ...
                    <div class="course-banner">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-2.jpg" alt="course banner">
                ...
                <div class="course-card">
                    ...
                    <div class="course-banner">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-3.jpg" alt="course banner">
                ...
                <div class="course-card">
                    ...
                    <div class="course-banner">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-4.jpg" alt="course banner">
                ...
                <div class="course-card">
                    ...
                    <div class="course-banner">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-5.jpg" alt="course banner">
                ...
                <div class="course-card">
                    ...
                    <div class="course-banner">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/course-6.jpg" alt="course banner">
        ...
        <section class="event">
            ...
            <div class="event-left">
                ...
                <div class="event-banner">
                    <img src="<?php echo get_template_directory_uri();?>./assets/images/event-img.jpg" alt="event banner" class="banner-img">
                </div>
        ...
        <section class="features">
            ...
            <div class="features-right">
                <img src="<?php echo get_template_directory_uri();?>./assets/images/coure-features-img.jpg" alt="core features image">
            </div>
            ...
            <div class="instructor-grid">
                ...
                <div class="instructor-card">
                    ...
                    <div class="instructor-img-box">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/instructor-1.jpg" alt="instructor louis sullivan">
                ...
                <div class="instructor-card">
                    ...
                    <div class="instructor-img-box">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/instructor-2.jpg" alt="instructor camden david">
                ...
                <div class="instructor-card">
                    ...
                    <div class="instructor-img-box">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/instructor-3.jpg" alt="instructor fiona dean">
                ...
                <div class="instructor-card">
                    ...
                    <div class="instructor-img-box">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/instructor-4.jpg" alt="instructor cherish sosa">
        ...
        <section class="testimonials">
            ...
            <div class="testimonials-right">
                ...
                <div class="testimonials-card">
                    <img src="<?php echo get_template_directory_uri();?>./assets/images/quote.png" alt="quote icon" class="quote-img">
                    ...
                    <div class="testimonials-client">
                        ...
                        <div class="client-img-box">
                            <img src="<?php echo get_template_directory_uri();?>./assets/images/client.jpg" alt="client christine rose">
                        </div>
            ...
            <div class="blog-grid">
                ...
                <div class="blog-card">
                    ...
                    <div class="blog-banner-box">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/blog-1.jpg" alt="blog banner">
                    </div>
                ...
                <div class="blog-card">
                    ...
                    <div class="blog-banner-box">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/blog-2.jpg" alt="blog banner">
                    </div>
                ...
                <div class="blog-card">
                    ...
                    <div class="blog-banner-box">
                        <img src="<?php echo get_template_directory_uri();?>./assets/images/blog-3.jpg" alt="blog banner">
                    </div>
        ...
        <section class="contact">
            ...
            <div class="contact-card" id="contact">
                <img src="<?php echo get_template_directory_uri();?>./assets/images/cta-bg-img.png" alt="shape" class="contact-card-bg">
    ...
    <footer>
        ...
        <div class="footer-grid">
            ...
            <div class="grid-item">
                ...
                <div class="footer-logo">
                    <img src="<?php echo get_template_directory_uri();?>./assets/images/logo-footer.png" alt="code.tn logo white">
                </div>
        ...
        <p class="copyright">
            Copyright © 2022 <a href="https://code.tn/">code.tn</a>. All rights reserved.
        </p>
